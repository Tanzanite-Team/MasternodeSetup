...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='tanzanite.conf'
CONFIGFOLDER='/root/.tanzanite'
COIN_DAEMON='tanzanited'
COIN_CLI='tanzanite-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/Tanzanite-Team/Tanzanite/releases/download/v1.0.0/Tanzanite-1.0-Linux.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='tanzanited'
COIN_EXPLORER='http://explorer.tanzanite.com'
COIN_PORT=52367
RPC_PORT=52366
